...
var require_color = __commonJS({
  "src/models/color.js"(exports2, module2) {
    var Color = class {
...
// src/models/colorLogger.js
var require_colorLogger = __commonJS({
  "src/models/colorLogger.js"(exports2, module2) {
    var { Color } = require_color();
    var ColorLogger2 = class {
      /**
    ...
    module2.exports = {
      ColorLogger: ColorLogger2
    };
  }
});

// src/models/fileHandler.js
var require_fileHandler = __commonJS({
  "src/models/fileHandler.js"(exports2, module2) {
    var fs2 = require_lib();
    var path = require("path");
    var { ColorLogger: ColorLogger2 } = require_colorLogger();
    var FileHandler = class {
      ...
      async copyFile(filePath) {
        ...
        try {
          await fs2.copy(filePath, destPath);
          ColorLogger2.success(`Copied: ${filePath} \u2794 ${destPath}`);
        } catch (err) {
          ColorLogger2.error(`Copy failed: ${filePath} \u2794 ${destPath} | ${err}`);
        }
      }
      /**
      ...
      async deleteFile(filePath) {
        ...
        const destPath = path.join(isBP ? this.destDirBP : this.destDirRP, relativePath.slice(3));
        try {
          await fs2.remove(destPath);
          ColorLogger2.delete(`Removed: ${destPath}`);
        } catch (err) {
          ColorLogger2.error(`Remove failed: ${destPath} | ${err}`);
        }
      }
      /**
      ...
      async refreshDir() {
        try {
          ...
          ColorLogger2.info(`Cleared: ${this.destDirBP} & ${this.destDirRP}`);
          await fs2.ensureDir(this.destDirBP);
          await fs2.ensureDir(this.destDirRP);
          ColorLogger2.info(`Recreated: ${this.destDirBP} & ${this.destDirRP}`);
          await fs2.copy(this.sourceDir + "/BP", this.destDirBP);
          await fs2.copy(this.sourceDir + "/RP", this.destDirRP);
          ColorLogger2.success(`Refreshed: ${this.sourceDir} \u2794 ${this.destDirBP} & ${this.destDirRP}`);
        } catch (err) {
          ColorLogger2.error(`Refresh failed | ${err}`);
        }
      }
      removeDestinationDirectories() {
        fs2.removeSync(this.destDirBP, { recursive: true });
        fs2.removeSync(this.destDirRP, { recursive: true });
      }
    };
    module2.exports = {
      FileHandler
...
// src/models/watcher.js
var require_watcher = __commonJS({
  "src/models/watcher.js"(exports2, module2) {
    ...
    var Watcher2 = class {
      ...
      startWatching() {
        ...
        if (fs2.existsSync(bpFolder)) {
          watchFolders.push(bpFolder);
        }
        if (fs2.existsSync(rpFolder)) {
          watchFolders.push(rpFolder);
        }
        if (watchFolders.length === 0) {
          ColorLogger2.error("No BP or RP folder found. Exiting...");
          return;
        }
        ...
        ColorLogger2.info("Watching for file changes...");
        const cleanUp = () => {
      ...
      stopWatching() {
        if (this.watcher) {
          try {
            ...
            ColorLogger2.error(`Error stopping the watcher: ${error}`);
          }
        } else {
          ColorLogger2.error("Watcher is not running.");
        }
      }
    };
    module2.exports = {
...
var require_config = __commonJS({
  "src/utils/config.js"(exports2, module2) {
    ...
    function readConfig2() {
      ...
      return JSON.parse(fs2.readFileSync("./config.json", "utf-8") || "{}");
    }
    module2.exports = {
...
// src/models/questioner.js
var require_questioner = __commonJS({
  "src/models/questioner.js"(exports2, module2) {
    var readline = require("readline");
    var { Color } = require_color();
    var Questioner2 = class {
...
// src/models/manifestGenerator.js
var require_manifestGenerator = __commonJS({
  "src/models/manifestGenerator.js"(exports2, module2) {
    var { v4: uuidv4 } = (init_esm_node(), __toCommonJS(esm_node_exports));
    var ManifestGenerator2 = class {
      /**
    ...
    module2.exports = {
      ManifestGenerator: ManifestGenerator2
    };
  }
});
